...
Questions for creating codex prompt



**guardrails**

• can't parse pdf that has only image, no text

• must convert to image PNG, then parse the PNG



• does KGS web site have api?

• how do we find the lease or well on KGS: 

&#x09;township/section/range	<=== BEST Public Land Survey Sysem (PLSS)

&#x09; should pull the lease name, or operator name to verify the PLSS fetch

&#x09;lat/lon			<== second best, if available

&#x09;legal desc		<== not recommended

• what are we looking for: well/lease active?



**observability**

• how to use Azure Monitor OpenTelemetry Distro for Python to connect to MS App Insights via Open Telemetry,

&#x09;pip install azure-monitor-opentelemetry opentelemetry-sdk

• how to instrument the python harness code

&#x09;import configure\_azure\_monitor from azure.monitor.opentelemetry

&#x09;import trace from opentelemetry

• how to verify OTel traces can route to App Insights (not blocked by virtual network gateway)



**security**

• Azure Cloud Defender (CNAPP) provides...
...
• how to detect attempted incursion

• how to implement RBAC

• how to do Static Application Security Testing (SAST) tool scans



**KPI metrics**

• how to trace HITL intervention

• how to see when trace totals don't match

• how to see token costs

• how to see throughput and velocity
...
Use the Operator ID and Well Name to look up the well on the  KGS Master Well List.

(apps.kgs.ku.edu/web/qualified/index)





, create the excel csv.

Otherwise, route to Human-In-The-Loop, and flag the discrepancies.
...
If the totals match, create the excel csv.

Otherwise, route to Human-In-The-Loop, and flag the discrepancies.

This excel csv shall not allow macros.

The spreadsheet column names shall be the Run Master Fields and Run Detail Fields, described in Step 6 above.
...
Render all extracted numbers with no padding and two decimal places, no rounding.
